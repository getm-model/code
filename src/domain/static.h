#include "dimensions.h"
   ...
   REALTYPE		:: lonmap(E2DFIELD)
   REALTYPE		:: latmap(E2DFIELD)
   ...
   REALTYPE		:: xx(imin-HALO:imax+HALO)
   REALTYPE		:: yx(jmin-HALO:jmax+HALO)
   REALTYPE		:: xc(imin-HALO:imax+HALO)
   REALTYPE		:: yc(jmin-HALO:jmax+HALO)
   REALTYPE		:: xu(imin-HALO:imax+HALO)
   REALTYPE		:: yu(jmin-HALO:jmax+HALO)
   REALTYPE		:: xv(imin-HALO:imax+HALO)
   REALTYPE		:: yv(jmin-HALO:jmax+HALO)
#endif
